...
default/config/tizen-tv/make_keymap_conf.sh
...
%__mkdir_p %{buildroot}/usr/share/enlightenment/data/config/tizen-tv
...
%__cp -afr default/config/tizen-tv/*.cfg %{buildroot}/usr/share/enlightenment/data/config/tizen-tv
...
/usr/share/enlightenment/data/config/tizen-tv/*.cfg
%if %{with x}
